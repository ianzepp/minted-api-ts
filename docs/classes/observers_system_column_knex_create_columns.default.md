[minted-api](../README.md) / [Exports](../modules.md) / [observers/system.column/knex-create-columns](../modules/observers_system_column_knex_create_columns.md) / default

# Class: default

[observers/system.column/knex-create-columns](../modules/observers_system_column_knex_create_columns.md).default
...
- [constructor](observers_system_column_knex_create_columns.default.md#constructor)

### Properties

- [Rank](observers_system_column_knex_create_columns.default.md#rank)
- [Ring](observers_system_column_knex_create_columns.default.md#ring)

### Methods

- [isFailable](observers_system_column_knex_create_columns.default.md#isfailable)
- [isRunnable](observers_system_column_knex_create_columns.default.md#isrunnable)
- [onCreate](observers_system_column_knex_create_columns.default.md#oncreate)
- [onDelete](observers_system_column_knex_create_columns.default.md#ondelete)
- [onExpire](observers_system_column_knex_create_columns.default.md#onexpire)
- [onRank](observers_system_column_knex_create_columns.default.md#onrank)
- [onRing](observers_system_column_knex_create_columns.default.md#onring)
- [onSchema](observers_system_column_knex_create_columns.default.md#onschema)
- [onSelect](observers_system_column_knex_create_columns.default.md#onselect)
- [onUpdate](observers_system_column_knex_create_columns.default.md#onupdate)
- [onUpsert](observers_system_column_knex_create_columns.default.md#onupsert)
- [run](observers_system_column_knex_create_columns.default.md#run)
- [toJSON](observers_system_column_knex_create_columns.default.md#tojson)
- [toName](observers_system_column_knex_create_columns.default.md#toname)
...
[src/observers/system.column/knex-create-columns.ts:23](https://github.com/ianzepp/minted-api-ts/blob/05123f2/src/observers/system.column/knex-create-columns.ts#L23)
...
[src/observers/system.column/knex-create-columns.ts:19](https://github.com/ianzepp/minted-api-ts/blob/05123f2/src/observers/system.column/knex-create-columns.ts#L19)
...
[src/observers/system.column/knex-create-columns.ts:15](https://github.com/ianzepp/minted-api-ts/blob/05123f2/src/observers/system.column/knex-create-columns.ts#L15)
...
[src/observers/system.column/knex-create-columns.ts:27](https://github.com/ianzepp/minted-api-ts/blob/05123f2/src/observers/system.column/knex-create-columns.ts#L27)
...
[src/observers/system.column/knex-create-columns.ts:11](https://github.com/ianzepp/minted-api-ts/blob/05123f2/src/observers/system.column/knex-create-columns.ts#L11)
