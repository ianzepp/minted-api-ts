[minted-api](../README.md) / [Exports](../modules.md) / [classes/system-data](../modules/classes_system_data.md) / RecordColumnImmutableError
...
- [cause](classes_system_data.RecordColumnImmutableError.md#cause)
...
• **new RecordColumnImmutableError**(`message?`, `options?`)
...
[DataError](classes_system_data.DataError.md).[cause](classes_system_data.DataError.md#cause)
