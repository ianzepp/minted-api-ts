...
- [cause](classes_http_server.HttpRouteNotFoundError.md#cause)
...
• **new HttpRouteNotFoundError**(`message?`, `options?`)
...
[HttpError](classes_http_server.HttpError.md).[cause](classes_http_server.HttpError.md#cause)
