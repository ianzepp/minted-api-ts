[minted-api](../README.md) / [Exports](../modules.md) / [observers/record.knex-select](../modules/observers_record_knex_select.md) / default

# Class: default

[observers/record.knex-select](../modules/observers_record_knex_select.md).default
...
- [constructor](observers_record_knex_select.default.md#constructor)

### Properties

- [Rank](observers_record_knex_select.default.md#rank)
- [Ring](observers_record_knex_select.default.md#ring)

### Methods

- [isFailable](observers_record_knex_select.default.md#isfailable)
- [isRunnable](observers_record_knex_select.default.md#isrunnable)
- [onCreate](observers_record_knex_select.default.md#oncreate)
- [onDelete](observers_record_knex_select.default.md#ondelete)
- [onRank](observers_record_knex_select.default.md#onrank)
- [onRing](observers_record_knex_select.default.md#onring)
- [onSchema](observers_record_knex_select.default.md#onschema)
- [onSelect](observers_record_knex_select.default.md#onselect)
- [onUpdate](observers_record_knex_select.default.md#onupdate)
- [onUpsert](observers_record_knex_select.default.md#onupsert)
- [run](observers_record_knex_select.default.md#run)
- [toJSON](observers_record_knex_select.default.md#tojson)
- [toName](observers_record_knex_select.default.md#toname)
...
[src/observers/record.knex-select.ts:22](https://github.com/ianzepp/minted-api-ts/blob/4ef4443/src/observers/record.knex-select.ts#L22)
...
[src/observers/record.knex-select.ts:18](https://github.com/ianzepp/minted-api-ts/blob/4ef4443/src/observers/record.knex-select.ts#L18)
...
[src/observers/record.knex-select.ts:26](https://github.com/ianzepp/minted-api-ts/blob/4ef4443/src/observers/record.knex-select.ts#L26)
...
[src/observers/record.knex-select.ts:30](https://github.com/ianzepp/minted-api-ts/blob/4ef4443/src/observers/record.knex-select.ts#L30)
...
[src/observers/record.knex-select.ts:14](https://github.com/ianzepp/minted-api-ts/blob/4ef4443/src/observers/record.knex-select.ts#L14)
