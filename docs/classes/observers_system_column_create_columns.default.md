[minted-api](../README.md) / [Exports](../modules.md) / [observers/system.column/create-columns](../modules/observers_system_column_create_columns.md) / default

# Class: default

[observers/system.column/create-columns](../modules/observers_system_column_create_columns.md).default
...
- [constructor](observers_system_column_create_columns.default.md#constructor)

### Properties

- [Rank](observers_system_column_create_columns.default.md#rank)
- [Ring](observers_system_column_create_columns.default.md#ring)

### Methods

- [cleanup](observers_system_column_create_columns.default.md#cleanup)
- [isFailable](observers_system_column_create_columns.default.md#isfailable)
- [isRunnable](observers_system_column_create_columns.default.md#isrunnable)
- [onCreate](observers_system_column_create_columns.default.md#oncreate)
- [onDelete](observers_system_column_create_columns.default.md#ondelete)
- [onExpire](observers_system_column_create_columns.default.md#onexpire)
- [onRank](observers_system_column_create_columns.default.md#onrank)
- [onRing](observers_system_column_create_columns.default.md#onring)
- [onSchema](observers_system_column_create_columns.default.md#onschema)
- [onSelect](observers_system_column_create_columns.default.md#onselect)
- [onUpdate](observers_system_column_create_columns.default.md#onupdate)
- [onUpsert](observers_system_column_create_columns.default.md#onupsert)
- [one](observers_system_column_create_columns.default.md#one)
- [run](observers_system_column_create_columns.default.md#run)
- [startup](observers_system_column_create_columns.default.md#startup)
- [toJSON](observers_system_column_create_columns.default.md#tojson)
- [toName](observers_system_column_create_columns.default.md#toname)
...
[src/observers/system.column/create-columns.ts:25](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.column/create-columns.ts#L25)
...
[src/observers/system.column/create-columns.ts:21](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.column/create-columns.ts#L21)
...
[src/observers/system.column/create-columns.ts:17](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.column/create-columns.ts#L17)
...
[src/observers/system.column/create-columns.ts:33](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.column/create-columns.ts#L33)
...
[src/observers/system.column/create-columns.ts:29](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.column/create-columns.ts#L29)
...
[src/observers/system.column/create-columns.ts:13](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.column/create-columns.ts#L13)
