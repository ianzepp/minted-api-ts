[minted-api](../README.md) / [Exports](../modules.md) / [routers/meta-export](../modules/routers_meta_export.md) / default

# Class: default

[routers/meta-export](../modules/routers_meta_export.md).default
...
- [constructor](routers_meta_export.default.md#constructor)

### Properties

- [Verb](routers_meta_export.default.md#verb)

### Accessors

- [params](routers_meta_export.default.md#params)
- [req](routers_meta_export.default.md#req)
- [res](routers_meta_export.default.md#res)
- [search](routers_meta_export.default.md#search)
- [system](routers_meta_export.default.md#system)

### Methods

- [is](routers_meta_export.default.md#is)
- [isHttpPath](routers_meta_export.default.md#ishttppath)
- [isHttpVerb](routers_meta_export.default.md#ishttpverb)
- [onHttpPath](routers_meta_export.default.md#onhttppath)
- [onHttpVerb](routers_meta_export.default.md#onhttpverb)
- [run](routers_meta_export.default.md#run)
- [runsafe](routers_meta_export.default.md#runsafe)
- [toName](routers_meta_export.default.md#toname)
...
[src/routers/meta-export.ts:16](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/routers/meta-export.ts#L16)
...
[src/routers/meta-export.ts:12](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/routers/meta-export.ts#L12)
...
[src/routers/meta-export.ts:8](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/routers/meta-export.ts#L8)
