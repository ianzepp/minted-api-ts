...
- [timestamp](classes_system.SystemAsCors.md#timestamp)
...
[src/classes/system.ts:130](https://github.com/ianzepp/minted-api-ts/blob/05123f2/src/classes/system.ts#L130)
...
▸ **authenticate**(): `Promise`<[`SystemAsCors`](classes_system.SystemAsCors.md)\>

#### Returns

`Promise`<[`SystemAsCors`](classes_system.SystemAsCors.md)\>
...
▸ **cleanup**(): `Promise`<[`SystemAsCors`](classes_system.SystemAsCors.md)\>
...
▸ **refresh**(): `Promise`<[`SystemAsCors`](classes_system.SystemAsCors.md)\>
...
▸ **startup**(): `Promise`<[`SystemAsCors`](classes_system.SystemAsCors.md)\>
