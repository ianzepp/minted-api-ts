[minted-api](../README.md) / [Exports](../modules.md) / [observers/system.record/knex-delete](../modules/observers_system_record_knex_delete.md) / default

# Class: default

[observers/system.record/knex-delete](../modules/observers_system_record_knex_delete.md).default
...
- [constructor](observers_system_record_knex_delete.default.md#constructor)

### Properties

- [Rank](observers_system_record_knex_delete.default.md#rank)
- [Ring](observers_system_record_knex_delete.default.md#ring)

### Methods

- [cleanup](observers_system_record_knex_delete.default.md#cleanup)
- [isFailable](observers_system_record_knex_delete.default.md#isfailable)
- [isRunnable](observers_system_record_knex_delete.default.md#isrunnable)
- [onCreate](observers_system_record_knex_delete.default.md#oncreate)
- [onDelete](observers_system_record_knex_delete.default.md#ondelete)
- [onExpire](observers_system_record_knex_delete.default.md#onexpire)
- [onRank](observers_system_record_knex_delete.default.md#onrank)
- [onRing](observers_system_record_knex_delete.default.md#onring)
- [onSchema](observers_system_record_knex_delete.default.md#onschema)
- [onSelect](observers_system_record_knex_delete.default.md#onselect)
- [onUpdate](observers_system_record_knex_delete.default.md#onupdate)
- [onUpsert](observers_system_record_knex_delete.default.md#onupsert)
- [run](observers_system_record_knex_delete.default.md#run)
- [startup](observers_system_record_knex_delete.default.md#startup)
- [toJSON](observers_system_record_knex_delete.default.md#tojson)
- [toName](observers_system_record_knex_delete.default.md#toname)
...
[src/observers/system.record/knex-delete.ts:38](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/knex-delete.ts#L38)
...
[src/observers/system.record/knex-delete.ts:24](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/knex-delete.ts#L24)
...
[src/observers/system.record/knex-delete.ts:20](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/knex-delete.ts#L20)
...
[src/observers/system.record/knex-delete.ts:16](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/knex-delete.ts#L16)
...
[src/observers/system.record/knex-delete.ts:28](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/knex-delete.ts#L28)
...
[src/observers/system.record/knex-delete.ts:12](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/knex-delete.ts#L12)
