[minted-api](../README.md) / [Exports](../modules.md) / [observers/system.record/test-maximum](../modules/observers_system_record_test_maximum.md) / default

# Class: default

[observers/system.record/test-maximum](../modules/observers_system_record_test_maximum.md).default
...
- [constructor](observers_system_record_test_maximum.default.md#constructor)

### Properties

- [Rank](observers_system_record_test_maximum.default.md#rank)
- [Ring](observers_system_record_test_maximum.default.md#ring)

### Methods

- [cleanup](observers_system_record_test_maximum.default.md#cleanup)
- [isFailable](observers_system_record_test_maximum.default.md#isfailable)
- [isRunnable](observers_system_record_test_maximum.default.md#isrunnable)
- [onCreate](observers_system_record_test_maximum.default.md#oncreate)
- [onDelete](observers_system_record_test_maximum.default.md#ondelete)
- [onExpire](observers_system_record_test_maximum.default.md#onexpire)
- [onRank](observers_system_record_test_maximum.default.md#onrank)
- [onRing](observers_system_record_test_maximum.default.md#onring)
- [onSchema](observers_system_record_test_maximum.default.md#onschema)
- [onSelect](observers_system_record_test_maximum.default.md#onselect)
- [onUpdate](observers_system_record_test_maximum.default.md#onupdate)
- [onUpsert](observers_system_record_test_maximum.default.md#onupsert)
- [run](observers_system_record_test_maximum.default.md#run)
- [startup](observers_system_record_test_maximum.default.md#startup)
- [toJSON](observers_system_record_test_maximum.default.md#tojson)
- [toName](observers_system_record_test_maximum.default.md#toname)
...
[src/observers/system.record/test-maximum.ts:25](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L25)
...
[src/observers/system.record/test-maximum.ts:21](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L21)
...
[src/observers/system.record/test-maximum.ts:17](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L17)
...
[src/observers/system.record/test-maximum.ts:29](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L29)
...
[src/observers/system.record/test-maximum.ts:33](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L33)
...
[src/observers/system.record/test-maximum.ts:37](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L37)
...
[src/observers/system.record/test-maximum.ts:13](https://github.com/ianzepp/minted-api-ts/blob/ce6db2f/src/observers/system.record/test-maximum.ts#L13)
